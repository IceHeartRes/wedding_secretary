...
DROP DATABASE IF EXISTS wedding_secretary_test;
--
-- Name: wedding_secretary_test; Type: DATABASE; Schema: -; Owner: wedding_admin
--

CREATE DATABASE wedding_secretary_test WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'ru_RU.UTF-8' LC_CTYPE = 'ru_RU.UTF-8';


ALTER DATABASE wedding_secretary_test OWNER TO wedding_admin;

\connect wedding_secretary_test
...
SELECT pg_catalog.setval('public.professional_categories_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.specialists_id_seq', 2, true);
